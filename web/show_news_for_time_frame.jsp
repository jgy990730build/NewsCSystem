...
<div class="container">
    <div class="row">
        <div class="col-8 offset-3">
            ...
            <s:form id="time_search" theme="simple" action="showTimeFrameResultNews" namespace="/NewsCSystem" class="form-inline">
                    <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">时间：</div>
                            <s:hidden name="sid" value="1"/>
                            <input type="date" name="date1" id="time1" class="form-control" placeholder="1840" label="时间1"/>
                        </div>
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">到：</div>
                            <input type="date" name="date2" id="time2" class="form-control" placeholder="1840" label="时间2"/>
                        </div>
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
                    <button type="button" id="search_t" class="btn btn-info" name="button">查询</button>
                    </div>
            </s:form>
        </div>
        <div class="col-8">
            <table class="table shadow p-3 mb-5 bg-white rounded">
                ...
                <tr>
                    <th scope="col" colspan="2">在这个时间段发生的事</th>
                </tr>
                </thead>
                <tbody>
                ...
                <s:if test="sid==0">
                    <nav aria-label="Page navigation" style="text-align: center;">
                        <ul class="pagination justify-content-center">
                            <s:if test="pageNow!=1">
                                <li class="page-item">
                                    <s:a class="page-link" href="NewsCSystem/showTimeFrameResultNews.action?pageNow=1">首页</s:a>
                                </li>
                            </s:if>
                            <s:else>
                            ...
                            <s:iterator begin="1" end="intPageCount" var="i">
                                ...
                                <s:else>
                                    <li class="page-item">
                                        <s:a class="page-link" href="NewsCSystem/showTimeFrameResultNews.action?pageNow=%{#i}"><s:property value="#i"/></s:a>
                                    </li>
                                </s:else>
                            </s:iterator>
                            <s:if test="pageNow!=k">
                                <li class="page-item">
                                    <s:a class="page-link" href="NewsCSystem/showTimeFrameResultNews.action?pageNow=%{k}">尾页</s:a>
                                </li>
                            </s:if>
                            <s:else>
                                <li class="page-item disabled">
                ...
                <s:else>
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            <s:url var="url_1" action="NewsCSystem/showTimeFrameResultNews.action">
                                <s:param name="pageNow" value="1"/>
                                <s:param name="sid" value="1"/>
                                <s:param name="date1" value="%{date1}"/>
                                <s:param name="date2" value="%{date2}"/>
                            </s:url>
                            <s:url var="url_2" action="NewsCSystem/showTimeFrameResultNews.action">
                                <s:param name="pageNow" value="%{k}"/>
                                <s:param name="sid" value="1"/>
                                <s:param name="date1" value="%{date1}"/>
                                <s:param name="date2" value="%{date2}"/>
                            </s:url>
                            <s:url var="url_3" action="NewsCSystem/showTimeFrameResultNews.action">
                            ...
                            <s:iterator begin="1" end="intPageCount" var="i">
                                ...
                                <s:else>
                                    <li class="page-item">
                                        <s:a class="page-link" href='NewsCSystem/showTimeFrameResultNews.action?pageNow=%{#i}&&sid=1&&date1=%{date1}&&date2=%{date2}'><s:property value="#i"/></s:a>
                                    </li>
                                </s:else>
                            </s:iterator>
                            <s:if test="pageNow!=k">
