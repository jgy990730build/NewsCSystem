...
<div class="container">
    <div class="row mt-5">
        <div class="col-8 shadow p-3 mb-5 bg-white rounded border border-secondary">
            <h1 class="text-center"><s:property value="news.title"/></h1>
            <div>
                <p class="float-left">来源：<s:property value="news.sourceFor"/> </p>
                <p class="float-right text-secondary">发布时间：<s:date name="news.issueTime" format="yyyy-MM-dd hh:mm:ss"/></p>
            </div>
        <hr>
