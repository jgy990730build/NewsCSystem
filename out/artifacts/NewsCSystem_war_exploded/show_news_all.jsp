    ...
    <div class="row">
        <div class="col-8">
            <table class="table shadow p-3 mb-5 bg-white rounded">
                ...
                <tr>
                    <th scope="col" colspan="2">所有新闻</th>
                </tr>
                </thead>
                <tbody>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <s:if test="pageNow!=1">
                        <li class="page-item">
                        <s:a class="page-link" href="NewsCSystem/showAllnewsNews.action?pageNow=1">首页</s:a>
                        </li>
                    </s:if>
                    <s:else>
                    ...
                    <s:iterator begin="1" end="intPageCount" var="i">
                        ...
                        <s:else>
                            <li class="page-item">
                            <s:a class="page-link" href="NewsCSystem/showAllnewsNews.action?pageNow=%{#i}"><s:property value="#i"/></s:a>
                            </li>
                        </s:else>
                    </s:iterator>
                    <s:if test="pageNow!=k">
                    <li class="page-item">
                        <s:a class="page-link" href="NewsCSystem/showAllnewsNews.action?pageNow=%{k}">尾页</s:a>
                    </li>
                    </s:if>
                    <s:else>
                        <li class="page-item disabled">
